        ...
        AnimatedContainer(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              fillColor: widget.fillColor ?? (isDark ? AppTheme.dark2 : ModernTheme.stone100.withValues(alpha: 0.5)),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          decoration: BoxDecoration(
            color: isDark ? AppTheme.dark2 : ModernTheme.stone100.withValues(alpha: 0.5),
